<template>
    <div class="row">
        <div class="col-12 category-color">
            <div class="row">
                ...
                <div class="col-8">
                    <div class="row navbar-bottom">
                        <div class="col-1">
                            <a href="#" class=" text-decoration-none"><img width="15" src="../assets/navbar/home.png"
                                    alt="">
                                ANA SAYFA</a>
                        </div>
                        <div class="col-1">
                        ...
                        <div class="col-1">
                            <router-link class="text-decoration-none" :to="{ path: '/sss' }">
                                <img width="15" src="../assets/navbar/blog.png" alt="">
                                S.S.S
                            </router-link>
